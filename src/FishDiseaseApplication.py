...
def show_welcome(txt):
    logo_path = r"C:\Users\User\Desktop\MayDegree\sem6\machine learning\Assignment\design\Copy of KD34403 Machine Learning Project Assignment_Progress Report Part A (1).png"
